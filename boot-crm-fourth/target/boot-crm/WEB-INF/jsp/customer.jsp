...
<script type="text/javascript">
    //清空新建客户窗口中的数据
    /*#new_customerName是添加客户动态框里面各个信息栏的id*/
    ...
    function createCustomer() {
        ...
        $("#new_customer_form").serialize()中的数据，controller需要使用@ResoponseBody接收
        callback:获取服务器返回的回调函数，格式为function(data,status){},data表示返回的数据，status表示状态，200表示成功。*/
    ...
    // 通过id获取修改的客户信息，将用户信息填写在动态框的信息栏上
    function editCustomer(id) {
        $.ajax({
            type: "get",
            url: "<%=basePath%>customer/getCustomerById.action",
            data: {"id": id},
            /*#edit_customerName是修改客户动态框里面各个信息栏的id*/
